...
# ═══════════════════════════════════════════════════════════════════════════
#  DATA ACQUISITION (Step 00)
# ═══════════════════════════════════════════════════════════════════════════

FETCH = {
    # EIA API key — gratuita: https://www.eia.gov/opendata/register.php
    # Può anche essere impostata come variabile d'ambiente EIA_API_KEY
    # (la variabile d'ambiente ha precedenza su questo valore).
    "eia_api_key": "0aa6ecc4e3694a179e72234add512fcc",

    # Balancing Authority ISO New England
    "eia_ba": "ISNE",

    # Nodo di riferimento LMP (Massachusetts Hub)
    "isone_hub": ".H.INTERNAL_HUB",

    # Ritardo tra richieste HTTP (secondi) — rispetta i rate limit ISO-NE / EIA
    "lmp_sleep_s":  0.2,   # tra un giorno e l'altro
    "eia_sleep_s":  0.3,   # tra una pagina e l'altra

    # Max tentativi per ogni richiesta HTTP fallita
    "max_retries": 3,

    # Dimensione pagina EIA (max 5000 per la v2 API)
    "eia_page_size": 5000,
}
